...
<p>Lloske est mon projet de fin d'étude. C'est une application dont l'objectif est d'offrir une interface intuitive pour visualiser les horaires, gérer les profils d'employés et assurer la communication des shifts de travail au personnel. Le projet comprend un front-end réalisé grâce à Angular et un back-end en DotNet. J'ai également implémenter une APIRestFull afin de communiquer avec ma base de donnée.</p>
...
<p>Il s'agit du premier exercice que j'ai fais lorsque la partie du cours sur les WebAPI a été introduite. Cet exercice nous demandais simplement de créer une base de donnée sql dans un projet c#.</p>
